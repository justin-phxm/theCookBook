...
import testimony0 from '../../public/placeholder-image.png'

export default function testimony(
    {testimonyImage, testimonyName, testimonyText, testimonySubtitle}: 
    {testimonyImage?: StaticImageData, testimonyName?: string, testimonyText?: string, testimonySubtitle?: string}
    ) {
  return (<>
