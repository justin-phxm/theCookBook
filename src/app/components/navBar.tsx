...
export default function NavBar() {
  ...
  return (
    <nav className="fixed flex w-11/12 flex-wrap items-center justify-between rounded-xl bg-primaryLight bg-opacity-20 p-4 drop-shadow-lg backdrop-blur-lg">
      ...
      <div
        className={`mt-4 w-full md:block md:w-auto ${!isCollapsed && "hidden"}`}
      >
