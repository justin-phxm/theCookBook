      ...
      >
        <ul className="mt-4 flex flex-col rounded-lg border border-gray-100 bg-gray-50 p-4 font-medium dark:border-gray-700 dark:bg-gray-800 md:mt-0 md:flex-row md:space-x-8 md:border-0 md:bg-inherit md:p-0 md:dark:bg-gray-900">
          <li>
            <Link
              href="/"
              className={`block rounded py-2 pl-3 pr-4 dark:text-white md:bg-transparent md:p-0 md:dark:text-green-500 ${
          ...
          <>
            ...
            <li>
              <Link
                href="/Recipes"
                className="block rounded-full bg-green-300 p-3 text-gray-900 hover:bg-green-400 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:border-0 md:py-0 md:hover:bg-green-400 md:hover:text-green-700 md:dark:hover:bg-transparent md:dark:hover:text-green-500"
              >
